      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-b from-sky-50 to-green-50 rounded-2xl shadow-2xl p-2 md:p-8">
          <div className="tree-container relative">
            ...
            <Fruit id="frutto1-3" x="22%" y="50%" data={fruitsData['frutto1-3']} />
            ...
            <Fruit id="frutto2-3" x="78%" y="50%" data={fruitsData['frutto2-3']} />

            {/* RAMO 3: Inglese - CENTRO ALTO */}
            <Fruit id="frutto3-1" x="50%" y="20%" data={fruitsData['frutto3-1']} />
            <Fruit id="frutto3-2" x="42%" y="28%" data={fruitsData['frutto3-2']} />
            <Fruit id="frutto3-3" x="58%" y="28%" data={fruitsData['frutto3-3']} />
